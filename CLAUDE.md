...
| `$script:ConnectVersion = '20260803.12'` | win connect.ps1 | Must match connect.bat guard + connect-version.txt |
| `CONNECT_VERSION='20260803.12'` | mac connect.sh | Must match published client version |
