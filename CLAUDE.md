...
| `$script:ConnectVersion = '20260725.37'` | win connect.ps1 | Must match connect.bat guard |
...
| `CONNECT_VERSION='20260725.37'` | mac connect.sh | Must match published client version |
