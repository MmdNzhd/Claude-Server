...
| `$script:ConnectVersion = '20260724.16'` | win connect.ps1 | Must match connect.bat guard |
...
| `CONNECT_VERSION='20260724.16'` | mac connect.sh | Must match published client version |
