...
| `$script:ConnectVersion = '20260802.1'` | win connect.ps1 | Must match connect.bat guard + connect-version.txt |
| `CONNECT_VERSION='20260802.1'` | mac connect.sh | Must match published client version |
