...
5. Every run after: choose project (Enter = last project), optionally set
   git mode (g) or IDE (c), Cursor or VS Code opens via Remote SSH.
...
LAST PROJECT
------------
  Press Enter at project menu to reconnect the last used project.
