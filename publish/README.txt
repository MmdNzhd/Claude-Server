...
5. Every run after: type a project number (empty Enter does nothing),
   ...
   Header must show:
     claude-server  |  192.168.210.240  |  v20260802.4
...
If you still see a lasting "Claude Connect" cmd on the taskbar:
  1. Confirm header version is current (v20260802.4+).
...
--------------------------
  Only ONE project is mounted per session. Requires connect scripts v20260802.4+
...
If connect.bat says OUTDATED:
  - Missing connect-ui.ps1 or version is not v20260802.4
