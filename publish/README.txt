...
Current connect scripts: v20260724.14
...
5. Every run after: type a project number (empty Enter does nothing),
   ...
   Header must show:
     claude-server  |  192.168.210.240  |  v20260724.14
...
--------------------------
  Only ONE project is mounted per session. Requires connect scripts v20260724.14+
...
If connect.bat says OUTDATED:
  - Missing connect-ui.ps1 or version is not v20260724.14
...
LOGS (durable on laptop + synced to server, v20260724.14+)
------------------------------------------------------------
