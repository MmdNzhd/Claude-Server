...
Current connect scripts: v20260803.11
...
5. Every run after: type a project number (empty Enter does nothing),
   ...
   Header must show:
     claude-server  |  192.168.210.240  |  v20260803.11
...
If you still see a lasting "Claude Connect" cmd on the taskbar:
  1. Confirm header version is current (v20260803.11+).
...
--------------------------
  Only ONE project is mounted per session. Requires connect scripts v20260803.11+
...
If connect.bat says OUTDATED:
  - Missing connect-ui.ps1 or version is not v20260803.11
...
LOGS (durable on laptop + synced to server, v20260803.11+)
------------------------------------------------------------
