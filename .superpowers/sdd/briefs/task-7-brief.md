...
## Notes
Register ALL new suites in run-all.ps1. Create test-incident-gap-replay-contract.ps1 for S6 A-E / S2 tokens. Docs markers in docs/client-connect.md. Run run-deploy-gate.ps1 (no -SkipTests). No version bump here (Task 8).
