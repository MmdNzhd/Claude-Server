...
pull scripts/client/windows/connect.bat "$STAGE/connect.bat"
pull scripts/client/windows/connect-hide-relaunch.vbs "$STAGE/connect-hide-relaunch.vbs"
pull scripts/client/windows/connect-hide-console.ps1 "$STAGE/connect-hide-console.ps1"
...
install -m 644 "$STAGE/connect.bat" "$B/connect.bat"
install -m 644 "$STAGE/connect-hide-relaunch.vbs" "$B/connect-hide-relaunch.vbs"
install -m 644 "$STAGE/connect-hide-console.ps1" "$B/connect-hide-console.ps1"
